...
function WatchPage() {
  ...
  // Creating the sliderRef for the similar movies
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mx-auto px-4 py-8 h-full mt-40">
            <h2 className="text-2xl sm:text-5xl font-bold text-balance">
              Content not found! Try another movie.
            </h2>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      <div className="bg-black min-h-screen text-white">
        <div className="mx-auto container px-4 py-8 min-h-full">
          <Navbar />
          ...
          <div className="aspect-video mb-8 p-2 sm:px-10 md:px-32">
            {trailers.length > 0 && currentTrailerIdx !== null && (
              <ReactPlayer
                controls={true}
                width={"100%"}
                height={"70vh"}
          ...
          {/* Movie Details */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-20 max-w-6xl mx-auto  p-4 bg-black rounded-lg">
            <div className="mb-4 md:mb-0">
              ...
              <p className="mt-4 w-4/6">{content?.overview}</p>
            </div>
