...
function SearchPage() {
  ...
  //   We have designed the contentType for not handling the actor/person, So this function will fix it.
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (error.response.status === 404) {
        toast.error(
          "Nothing found, make sure you are searching under right category."
        );
      } else {
